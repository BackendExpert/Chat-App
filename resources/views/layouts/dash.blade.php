...
<div class="d-flex" id="wrapper">
    ...
    <div class="bg-white" id="sidebar-wrapper">
        <div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom"><i class="fa-sharp fa-solid fas fa-rss"></i> Online Chat</div>
        <div class="list-group list-group-flush my-3">
            ...
            <a href="{{url('')}}" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                    class="fas fa-home me-2"></i>All Contacts</a>
